  ...
  return (
    <footer className=" relative bg-white text-neutral-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 md:py-14 grid grid-cols-1 md:grid-cols-4 gap-10 ">
        ...
        >
          <Link to="/">
            <h1 className="text-4xl text-neutral-900 md:text-5xl font-serif tracking-tight">
              KAVYASS
            </h1>
          </Link>
      ...
      <div className="absolute  w-full text-center bottom-0 translate-y-[65%] md:translate-y-[45%] lg:translate-y-[75%]">
        <h1 className="tracking-wider text-[clamp(4rem,20vw,18rem)] text-neutral-900 opacity-90 font-bold ">
          KAVYASS
        </h1>
      </div>
    </footer>
...
function FooterColumn({ title, links }) {
  return (
    ...
    >
      <h4 className="text-sm font-medium mb-3 tracking-wide text-neutral-900">
        {title}
      </h4>
